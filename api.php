...
$botToken = "5554931480:AAFu7MNEvWdJ5egNu6wdAR0kpWOd3aBKEO4";
...
function sendMessage1 ($chatId,$message) {
        ...
        $url = $GLOBALS[website]."/sendMessage?chat_id=-1961582245&text=".$message."&reply_to_message_id=".$message_id."&parse_mode=HTML";
        file_get_contents($url);
